...
חובה לבדוק תלויות והשפעות רוחב ולמפות אותם לפני תיקון ואו בנייה ולהציג סיכונים אם קיימים והדרך להמנע מהם .
...
```
אסור בכל אופן להצהיר הצהרות שוא של קריאה בפועל ללא קריאה אמיתית והסתמכות על זיכרון פינימי.
### ג. אכיפה
...
### ג. איסור דחיפת גרסאות (Push/Publish) - חובה מוחלטת
- **אין לדחוף גרסה (EAS Submit / OTA Update) ללא אישור מפורש בכתב.**
- **לפני דחיפה:**
    1. יש לדווח על כל השינויים שבוצעו.
    2. יש להציג את רשימת הבאגים שתוקנו ואלו שלא.
    3. יש לשאול במפורש: "האם לדחוף גרסה?"
    4. להמתין לאישור חיובי ברור.
